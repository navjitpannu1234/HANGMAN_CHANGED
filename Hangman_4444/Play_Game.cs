...
{
    [Activity(Label = "Play_Game")]
    public class Play_Game : Activity
    {
        private ImageView Hangman_image;
        private ImageButton  btn_image_home;
        private Button btnStart;
        // All Buttons Declared 
       // private Button  btn_view_score;
        private Button btnA;
        private Button btnB;
        private Button btnC;
        private Button btnD;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Play_Game_Layout);
            LoadWords();

            btn_image_home= FindViewById<ImageButton >(Resource.Id.btn_image_home);
            btn_image_home.Click += Btn_image_home_Click;
            btnNewGame = FindViewById<Button>(Resource.Id.btnStart);
           ...
           // btngameMainMenu.Click += btngameMainMenu_Click;
            ...
            All_Disable_Buttons();
            imgHangman = FindViewById<ImageView>(Resource.Id.Hangman_image);
            Load_blank_Image();
        ...
        private void Btn_image_home_Click(object sender, EventArgs e)
        {
        ...
        private void GuessFailed()
        {
            switch (GuessesLeft)
            {
                case 7:
                    ...
                    imgHangman.SetImageResource(Resource.Drawable.Fail1);

                    break;
                case 6:
                    imgHangman.SetImageResource(Resource.Drawable.Fail2);

                    break;
                case 5:
                    imgHangman.SetImageResource(Resource.Drawable.Fail3);
                    break;

                case 4:
                    imgHangman.SetImageResource(Resource.Drawable.Fail4);

                    break;

                case 3:
                    imgHangman.SetImageResource(Resource.Drawable.Fail5);

                    break;

                case 2:
                    imgHangman.SetImageResource(Resource.Drawable.Fail6);

                    break;

                case 1:
                    imgHangman.SetImageResource(Resource.Drawable.Fail7);

                    break;

                // Case 0(0 turns left), the player has lost the game.  
                case 0:
                    imgHangman.SetImageResource(Resource.Drawable.Fail8);
                    ...
                    System.Threading.Thread.Sleep(200);
                    Toast.MakeText(this, "Highest Score Is 145, You have run out of guesses! You LOSE. Your Score was " + score, ToastLength.Short).Show();
        ...
        private void GameWon()
        {
            ...
            Load_blank_Image();
            // Display the text
            Toast.MakeText(this, "Highest Score Is 45, You guessed the word correctly", ToastLength.Short).
            Show();
            var cc = new ConnectionClass();
            cc.UpdateScore(Id, PlayerName, score);
            // And load a new word
